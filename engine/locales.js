export const LOCALES = {
  en: {
    ...
    events: { check: 'Check', checkmate: 'Checkmate', promotion: 'Promotion', gardez: 'Gardez' },
    turn: 'Turn',
  ...
  de: {
    ...
    events: { check: 'Schach', checkmate: 'Schachmatt', promotion: 'Umwandlung', gardez: 'Gardez' },
    turn: 'Am Zug',
  ...
  fr: {
    ...
    events: { check: '\u00c9chec', checkmate: '\u00c9chec et mat', promotion: 'Promotion', gardez: 'Gardez' },
    turn: 'Tour',
  ...
  es: {
    ...
    events: { check: 'Jaque', checkmate: 'Jaque mate', promotion: 'Promoci\u00f3n', gardez: 'Gardez' },
    turn: 'Turno',
  ...
  it: {
    ...
    events: { check: 'Scacco', checkmate: 'Scacco matto', promotion: 'Promozione', gardez: 'Gardez' },
    turn: 'Turno',
  ...
  zh_TW: {
    ...
    events: { check: '\u5c07\u8ecd', checkmate: '\u5c07\u6b7b', promotion: '\u6642\u5347', gardez: 'Gardez' },
    turn: '\u8ab0\u7684\u56de合',
  ...
  uk: {
    ...
    events: { check: '\u0428\u0430\u0445', checkmate: '\u0428\u0430\u0445 \u0456 \u043c\u0430\u0442', promotion: '\u041f\u0440\u043e\u043c\u043e\u0446\u0456\u044f', gardez: 'Gardez' },
    turn: '\u0425\u0456\u0434',
